...
import { MenuNavBarComponent } from './modules/main-client/menu-nav-bar/menu-nav-bar.component';
import { HeaderClientComponent } from './modules/main-client/header-client/header-client.component';
import { FooterClientComponent } from './modules/main-client/footer-client/footer-client.component';
